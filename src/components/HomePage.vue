                ...
                <v-col cols="12" md="11" lg="10">
                    <v-row align="center">
                            ...
                            <div class="d-flex align-center bg-white pa-6 rounded-xl border border-opacity-10 mb-6"
                                ...
                                <div>
                                    ...
                                    <div class="text-h6 font-weight-black text-black">
                                        {{ userDetails.subscription ? `Active • Expiring in ${expiryDays} days` :
                                        'Explore our bundles' }}
                                    </div>
                                </div>
                                <v-spacer></v-spacer>
                        ...
                        <v-col cols="12" md="5" class="d-flex justify-md-end">
                            <v-card class="pa-10 bg-black text-white text-center" elevation="12" rounded="xl"
                                width="100%" max-width="440">
                                <v-img
                                    src="https://api.qrserver.com/v1/create-qr-code/?size=240x240&data=MACFIT-USER-123456"
